...
public class DallasTraffic extends Activity {
	...
	protected static final String TRAFFIC_MAP_URL = "http://osilabs.com/m/mobilecontent/dallastraffic/trafficmap.php";
	protected static final String INCIDENT_FEED = "http://www.dot.state.mn.us/tmc/trafficinfo/incidents.xml";
	protected static final String MOBILECONTENT_URL_ABOUT = "http://osilabs.com/m/mobilecontent/about/dt_about.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		try {
			pInfo = getPackageManager().getPackageInfo("com.osilabs.android.apps.dallastraffic",
		...
		SharedPreferences mySharedPreferences = getSharedPreferences(
                "com.osilabs.android.apps.dallastraffic", Activity.MODE_PRIVATE);
	...
	public boolean setCurrentView(int viewIndex) {
    	...
    	SharedPreferences prefs 
			= getSharedPreferences("com.osilabs.android.apps.dallastraffic", Activity.MODE_PRIVATE);
